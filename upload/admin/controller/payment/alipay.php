...
class ControllerPaymentAlipay extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['alipay_currency_code'])) {
			$this->data['alipay_currency_code'] = $this->request->post['alipay_currency_code'];
		} else {
			$this->data['alipay_currency_code'] = $this->config->get('alipay_currency_code');
		}
		...
		if (isset($this->request->post['alipay_wait_buyer_pay'])) {
			$this->data['alipay_wait_buyer_pay'] = $this->request->post['alipay_wait_buyer_pay'];
		} else {
			$this->data['alipay_wait_buyer_pay'] = $this->config->get('alipay_wait_buyer_pay'); 
		} 
		
		if (isset($this->request->post['alipay_wait_buyer_confirm'])) {
			$this->data['alipay_wait_buyer_confirm'] = $this->request->post['alipay_wait_buyer_confirm'];
		} else {
			$this->data['alipay_wait_buyer_confirm'] = $this->config->get('alipay_wait_buyer_confirm'); 
		} 		
		
		if (isset($this->request->post['alipay_trade_finished'])) {
			$this->data['alipay_trade_finished'] = $this->request->post['alipay_trade_finished'];
		} else {
			$this->data['alipay_trade_finished'] = $this->config->get('alipay_trade_finished'); 
		} 		
		
		if (isset($this->request->post['alipay_wait_seller_send'])) {
			$this->data['alipay_wait_seller_send'] = $this->request->post['alipay_wait_seller_send'];
		} else {
			$this->data['alipay_wait_seller_send'] = $this->config->get('alipay_wait_seller_send'); 
		} 
	...
	private function validate() {
		...
		if (!$this->request->post['alipay_currency_code']) {

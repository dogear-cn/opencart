	...
	<tr>
	  ...
	  <?php if ($error_secrity_code) { ?>
        ...
        <tr>
            ...
            <td><select name="alipay_currency_code">
        ...
        <tr>
          ...
          <td><select name="alipay_wait_buyer_pay">
              <?php foreach ($order_statuses as $order_status) { ?>
        ...
        <tr>
          ...
          <td><select name="alipay_wait_seller_send">
              <?php foreach ($order_statuses as $order_status) { ?>
        ...
        <tr>
          ...
          <td><select name="alipay_wait_buyer_confirm">
              <?php foreach ($order_statuses as $order_status) { ?>
        ...
        <tr>
          ...
          <td><select name="alipay_trade_finished">
              <?php foreach ($order_statuses as $order_status) { ?>
